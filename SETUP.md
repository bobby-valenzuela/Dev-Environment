...
- Common Generals
```bash
sudo apt install make gcc ripgrep unzip git git-all xclip zsh build-essential p7zip-full jq curl locate sshfs sshpass xsel lua5.3 cmake xse libstdc++6 vim-gtk3 libc6-dev libc6-dev-i386 nasm binutils -y 
```
