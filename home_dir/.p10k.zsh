# Generated by Powerlevel10k configuration wizard on 2023-07-05 at 22:10 PDT.
...
() {
  ...
  # Connect right prompt lines with these symbols.
   #typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%240FΓöÇΓò«'
   #typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%240FΓöÇΓöñ'
   #typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%240FΓöÇΓò»'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=69      #  DEFAULT: 2
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=39   # DEFAULT: 3
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=69  # DEFAULT: 2
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=39 # DEFAULT: 3
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=233
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=234
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=105
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=234
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=043
